...
# ============================================================
# vLLM Server Startup Script - Thinking Mode
# ============================================================
# Model:      Qwen3.6-27B-FP8
# Hardware:   2x AMD Radeon RX 9700 PRO (gfx1201/RDNA4)
# Optimized:  BF16 KV cache + MTP speculative decoding
# Thinking:   ON (reasoning-parser qwen3)
# Port:       8001
#
# Key design decisions:
#   - Same decode optimizations as non-thinking instance
#   - Thinking enabled for complex analysis, math, debugging
#   - Runs on port 8001 (separate from non-thinking on 8000)
#   - Use for skills that need deep reasoning (analysis, architecture)
# ============================================================
...
echo "================================================================"
echo "  vLLM Server - Thinking Mode"
...
echo "  Thinking:  ON (reasoning-parser qwen3)"
echo "  Port:      8001"
echo "================================================================"
